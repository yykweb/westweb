...
<head>
    ...
    <script type="text/javascript" src="{{__ROOT__}}/resource/admin/js/select.js"></script>
    <title>会员管理中心</title>
    <script>
        function check(){
            if ($('User_Name').value=="") {
...
<div id="biaoge">
    ...
    <div class="box">
        ...
        <form id='sub' action='{{U("admin/member/doadd")}}' method="post">
                ...
                <tr>
                    <td><table width="97%" cellpadding="0" cellspacing="1" border="0" align="center" bgcolor="#F0F0F0" style="margin:20px 0px 0px 0px;">
                            <tr class="bbj33" bgcolor="#FFFFFF">
                                ...
                                <td align="left" style="padding-left:10px;"><input name="user_name" id='User_Name' type="text" class="txt5" onblur="check_pass('user_name','','{{U("admin/member/ajax_user")}}','check_user');"/>&nbsp;&nbsp;<span id='check_user'></span></td>
                            </tr>
                            <tr class="bbj33" bgcolor="#FFFFFF">
                            ...
                            <tr class="bbj33" bgcolor="#FFFFFF">
                                ...
                                <td align="left" style="padding-left:10px;">
                                    <select name='member_level_id' id='Member_Level_ID'>
                                        <list from='$level' name='$l'>
                                            <option value="{$l['id']}">{{$l['member_level']}}</option>
                                        </list>
                                    </select>
                                </td>
                            </tr>
